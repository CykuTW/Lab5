...
int turn_on_led(void) {
    ...
    fp = open_file(/*"/sys/class/gpio/export"*/"/tmp/lab5", O_WRONLY, 0);
    write_file(fp, GPIO_NUMBER, GPIO_NUMBER_LEN);
    close_file(fp);

    fp = open_file(/*"/sys/class/gpio/gpio166/direction"*/"/tmp/lab5", O_WRONLY, 0);
    write_file(fp, "out", 3);
    close_file(fp);

    fp = open_file(/*"/sys/class/gpio/gpio166/value"*/"/tmp/lab5", O_WRONLY, 0);
    write_file(fp, "1", 1);
    close_file(fp);
...
int turn_off_led(void) {
    ...
    fp = open_file(/*"/sys/class/gpio/unexport"*/"/tmp/lab5", O_WRONLY, 0);
    write_file(fp, GPIO_NUMBER, GPIO_NUMBER_LEN);
    close_file(fp);
